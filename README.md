# OptimumPicks Frontend

Modern web application for visualizing sports betting odds and predictions, built with React and TypeScript.
...
- Real-time sports betting odds visualization
